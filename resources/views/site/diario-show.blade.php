...
@foreach($diarios as $diario)
    ...
    <div class="cabecalho" style="display: flex;">
        <input type="text" name="title" value="{{ $diario->title }}" class="d-inline-block ml-auto mr-1" style="border: 1px solid #000000; border-radius: 8px; width: 400px; color: black; padding-left: 10px;" placeholder="Title">
